...
SAIM (SeismoArch Iot Model) is low-cost, building-level earthquake early-warning system designed to detect **primary seismic waves (P-waves)** and issue alerts **seconds before destructive shaking occurs**.
